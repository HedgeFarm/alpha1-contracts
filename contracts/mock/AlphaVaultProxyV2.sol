...
/// @title AlphaVaultProxyV2
/// @author HedgeFarm
/// @notice A vault with simple epoch gestion for the Alpha 1 strategy of HedgeFarm.
contract AlphaVaultProxyV2 is ERC20Upgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable, UUPSUpgradeable {
    ...
    function start() external onlyManagerOwner nonReentrant {
        ...
        // Deposit 80% of funds in a yield protocol
        ...
        IERC20Upgradeable(token).safeTransfer(manager, IERC20Upgradeable(token).balanceOf(address(this)));
